...
namespace Dapper {
    ...
    public struct CommandDefinition {
        ...
        public bool Buffered {
            get {
                return (flags & CommandFlags.Buffered) != 0;
            }
        }
        ...
        internal bool AddToCache {
            get {
                return (flags & CommandFlags.NoCache) == 0;
            }
        }
        ...
        public bool Pipelined {
            get {
                return (flags & CommandFlags.Pipelined) != 0;
            }
        }
        ...
        private static Action<IDbCommand> GetInit(Type commandType) {
            ...
            if (bindByName != null || initialLongFetchSize != null) {
                DynamicMethod method = new DynamicMethod(commandType.Name + "_init", null, new Type[] {
                    typeof (IDbCommand)
                });
    ...
    static partial class SqlMapper {
        ...
        internal partial class Link<TKey, TValue> where TKey : class {
            ...
            public static bool TryAdd(ref Link<TKey, TValue> head, TKey key, ref TValue value) {
                ...
                do {
                    ...
                    Link<TKey, TValue> newNode = new Link<TKey, TValue>(key, value, snapshot);
        ...
        private static void PurgeQueryCacheByType(Type type) {
            lock (_queryCache) {
                Identity[] toRemove = _queryCache.Keys.Where(id => id.type == type).ToArray();
                foreach (Identity key in toRemove) {
...
#pragma warning disable 618
            typeof (TypeHandlerCache<>).MakeGenericType(type).GetMethod("SetHandler",
                BindingFlags.Static | BindingFlags.NonPublic).Invoke(null, new object[] {
                    handler
                });
            if (secondary != null) {
                typeof (TypeHandlerCache<>).MakeGenericType(secondary).GetMethod("SetHandler",
                    BindingFlags.Static | BindingFlags.NonPublic).Invoke(null, new object[] {
                        handler
                    });
            }
#pragma warning restore 618
        ...
        /// </summary>
        [Obsolete("Not intended for direct usage", false), Browsable(false), EditorBrowsable(EditorBrowsableState.Never)
        ]
...
#pragma warning restore 618
    ...
    /// <returns>Number of rows affected</returns>
        ...
        /// </summary>
        /// <returns>An <see cref="IDataReader"/> that can be used to iterate over the results of the SQL query.</returns>
        public static IDataReader ExecuteReader(this IDbConnection cnn,
                                                string sql,
                                                object param,
                                                IDbTransaction transaction) {
        ...
        /// </summary>
        public static GridReader QueryMultiple(this IDbConnection cnn,
                                               string sql,
                                               object param,
                                               IDbTransaction transaction) {
        ...
        public static object ExecuteScalar(
            ...
            CommandDefinition command = new CommandDefinition(sql, (object) param, transaction, commandTimeout,
    ...
    /// </summary>
        ...
        /// Return a list of dynamic objects, reader is closed after the call
        /// </summary>
        public static IEnumerable<IDictionary<string, object>> Query(this IDbConnection cnn,
                                                                     string sql,
                                                                     object param,
                                                                     IDbTransaction transaction) {
        ...
        public static IEnumerable<IDictionary<string, object>> Query(this IDbConnection cnn,
                                                                     ...
                                                                     int? commandTimeout,
                                                                     CommandType? commandType) {
            return Query<IDictionary<string, object>>(cnn, sql, param, transaction, buffered, commandTimeout,
                commandType);
        }
#endif
        ...
        public static IEnumerable<T> Query<T>(
            ...
            CommandDefinition command = new CommandDefinition(sql, (object) param, transaction, commandTimeout,
                commandType, buffered ? CommandFlags.Buffered : CommandFlags.None);
        ...
        private static GridReader QueryMultipleImpl(this IDbConnection cnn, ref CommandDefinition command) {
            ...
            try {
                ...
                GridReader result = new GridReader(cmd, reader, identity, command.Parameters as DynamicParameters);
        ...
        private static IEnumerable<T> QueryImpl<T>(this IDbConnection cnn, CommandDefinition command, Type effectiveType) {
            object param = command.Parameters;
            Identity identity = new Identity(command.CommandText, command.CommandType, cnn, effectiveType,
                param == null ? null : param.GetType(), null);
            CacheInfo info = GetCacheInfo(identity, param, command.AddToCache);
        ...
        private static IEnumerable<TReturn> MultiMapImpl
            ...
            identity = identity
                       ?? new Identity(command.CommandText, command.CommandType, cnn, typeof (TFirst),
                           param == null ? null : param.GetType(), new[] {
            ...
            try {
                ...
                if ((deserializer = cinfo.Deserializer).Func == null
                    ...
                    Func<IDataReader, object>[] deserializers = GenerateDeserializers(new Type[] {
                        typeof (TFirst), typeof (TSecond), typeof (TThird), typeof (TFourth), typeof (TFifth),
                        typeof (TSixth), typeof (TSeventh)
                    }, splitOn, reader);
        ...
        private static IEnumerable<TReturn> MultiMapImpl<TReturn>(this IDbConnection cnn,
                                                                  CommandDefinition command,
                                                                  Type[] types,
                                                                  Func<object[], TReturn> map,
                                                                  string splitOn,
            ...
            try {
                ...
                Func<IDataReader, TReturn> mapIt = GenerateMapper(types.Length, deserializer.Func, otherDeserializers,
                    map);
        ...
        private static Func<IDataReader, object>[] GenerateDeserializers(Type[] types,
                                                                         string splitOn,
                                                                         IDataReader reader) {
        ...
        private static void PassByPosition(IDbCommand cmd) {
            ...
            Dictionary<string, IDbDataParameter> parameters =
                new Dictionary<string, IDbDataParameter>(StringComparer.InvariantCulture);
        ...
        private static Func<IDataReader, object> GetDeserializer(Type type,
                                                                 IDataReader reader,
                                                                 int startBound,
                                                                 int length,
...
#if !CSHARP30
        internal static Func<IDataReader, object> GetDapperRowDeserializer(IDataRecord reader,
                                                                           int startBound,
                                                                           int length,
                                                                           bool returnNullIfFirstMissing) {
...
#else
        internal static Func<IDataReader, object> GetDictionaryDeserializer(IDataRecord reader,
                                                                            int startBound,
                                                                            int length,
                                                                            bool returnNullIfFirstMissing) {
        ...
        public static IDbDataParameter FindOrAddParameter(IDataParameterCollection parameters,
                                                          IDbCommand command,
                                                          string name) {
...
#pragma warning restore 0618
        ...
        internal static IList<LiteralToken> GetLiteralTokens(string sql) {
            ...
            HashSet<string> found = new HashSet<string>(StringComparer.InvariantCulture);
        ...
        internal static Action<IDbCommand, object> CreateParamInfoGenerator(Identity identity,
            ...
            DynamicMethod dm = new DynamicMethod(string.Format("ParamInfo{0}", Guid.NewGuid()), null, new[] {
                typeof (IDbCommand), typeof (object)
            }, type, true);
            ...
            if (ctors.Length == 1 && propsArr.Length == (ctorParams = ctors[0].GetParameters()).Length) {
                ...
                if (ok) {
                    ...
                    Dictionary<string, int> positionByName =
...
#pragma warning restore 618
        ...
        private static readonly Dictionary<TypeCode, MethodInfo> toStrings = new[] {
            ...
            x => x.GetMethod("ToString", BindingFlags.Public | BindingFlags.Instance, null, new[] {
        ...
        private static readonly MethodInfo StringReplace = typeof (string).GetMethod("Replace",
            BindingFlags.Instance | BindingFlags.Public, null, new Type[] {
                typeof (string), typeof (string)
                                           ...
                                           InvariantCulture =
                                               typeof (CultureInfo).GetProperty("InvariantCulture",
                                                   BindingFlags.Public | BindingFlags.Static).GetGetMethod();

        private static int ExecuteCommand(IDbConnection cnn,
                                          ref CommandDefinition command,
        ...
        private static T ExecuteScalarImpl<T>(IDbConnection cnn, ref CommandDefinition command) {
            ...
            object param = command.Parameters;
            if (param != null) {
                Identity identity = new Identity(command.CommandText, command.CommandType, cnn, null, param.GetType(),
                    null);
        ...
        private static IDataReader ExecuteReaderImpl(IDbConnection cnn,
                                                     ref CommandDefinition command,
                                                     CommandBehavior commandBehavior,
                                                     out IDbCommand cmd) {
...
#pragma warning restore 618
        ...
        public static Func<IDataReader, object> GetTypeDeserializer(
            ...
            DynamicMethod dm = new DynamicMethod(string.Format("Deserialize{0}", Guid.NewGuid()), typeof (object),
                new[] {
                    typeof (IDataReader)
                }, true);
            ILGenerator il = dm.GetILGenerator();
            ...
            if (type.IsValueType) {
                ...
                if (explicitConstr != null) {
                    Dictionary<Type, LocalBuilder> structLocals = new Dictionary<Type, LocalBuilder>();
                ...
                if (item != null) {
                    ...
                    if (memberType == typeof (char) || memberType == typeof (char?)) {
                        ...
                        if (unboxType.IsEnum) {
                            ...
                            if (nullUnderlyingType != null) {
                                il.Emit(OpCodes.Newobj, memberType.GetConstructor(new[] {
                                    nullUnderlyingType
                                }));// stack is now [target][target][typed-value]
                            }
                        }
                            ...
                            il.Emit(OpCodes.Newobj, memberType.GetConstructor(new Type[] {
                                typeof (byte[])
...
#pragma warning restore 618
                                ...
                                if (nullUnderlyingType != null) {
                                    il.Emit(OpCodes.Newobj, unboxType.GetConstructor(new[] {
                                        nullUnderlyingType
                                    }));// stack is now [target][target][typed-value]
                                }
    ...
    /// </summary>
            ...
            private IEnumerable<TReturn> MultiReadInternal
                ...
                Identity identity = this.identity.ForGrid(typeof (TReturn), new Type[] {
                    typeof (TFirst),
                    typeof (TSecond),
                    typeof (TThird),
                    typeof (TFourth),
                    ...
                    foreach (
                        TReturn r in
                            MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(
                                                                                                              null,
                                default(CommandDefinition), func, splitOn, reader, identity, false)) {
                        yield return r;
                    }
                }
                finally {
    ...
    /// </summary>
            ...
            public IEnumerable<TReturn> Read<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(
                ...
                string splitOn = "id",
                bool buffered = true) {
                var result = MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, DontMap, DontMap, TReturn>(
                                                                                                                    func,
                    splitOn);
                return buffered ? result.ToList() : result;
            }
            ...
            public IEnumerable<TReturn> Read<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn>(
                ...
                string splitOn = "id",
                bool buffered = true) {
                var result = MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, DontMap, TReturn>(
                                                                                                                   func,
                    splitOn);
                return buffered ? result.ToList() : result;
            }
            ...
            public IEnumerable<TReturn> Read<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(
                ...
                string splitOn = "id",
                bool buffered = true) {
                var result = MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(
                                                                                                                    func,
                    splitOn);
                return buffered ? result.ToList() : result;
            }
        ...
        /// </summary>
        public static ICustomQueryParameter AsTableValuedParameter(this DataTable table,
                                                                   string typeName
#if !CSHARP30
                                                                       = null
#endif
        ...
        private static StringBuilder GetStringBuilder() {
            StringBuilder tmp = perThreadStringBuilderCache;
            if (tmp != null) {
    ...
    partial class DynamicParameters : SqlMapper.IDynamicParameters, SqlMapper.IParameterLookup,
        ...
        #region IParameterCallbacks Members

        void SqlMapper.IParameterCallbacks.OnCompleted() {
            foreach (ParamInfo param in (from p in parameters select p.Value)) {
        ...
        #region IParameterLookup Members
        ...
        public void AddDynamicParams(object param) {
            ...
            if (obj != null) {
                DynamicParameters subDynamic = obj as DynamicParameters;
                if (subDynamic == null) {
        ...
        protected void AddParameters(IDbCommand command, SqlMapper.Identity identity) {
            ...
            if (templates != null) {
                ...
                List<Action> tmp = outputCallbacks;
                if (tmp != null) {
...
#pragma warning restore 612, 618
...
#else
        public DynamicParameters Output<T>(T target,
...
#endif
        {
            ...
            string dynamicParamName = string.Join(string.Empty, names.ToArray());
            ...
            DynamicMethod dm = new DynamicMethod(string.Format("ExpressionParam{0}", Guid.NewGuid()), null, new[] {
            ...
            MethodInfo paramGetter = GetType().GetMethod("Get", new Type[] {
                typeof (string)
            ...
            (outputCallbacks ?? (outputCallbacks = new List<Action>())).Add(() => {
                ...
                ParamInfo parameter;
                Type targetMemberType = lastMemberAccess.Type;
                int sizeToSet = (!size.HasValue && targetMemberType == typeof (string))
                    ? DbString.DefaultLength : size ?? 0;
                ...
                if (parameters.TryGetValue(dynamicParamName, out parameter)) {
                    ...
                    dbType = (!dbType.HasValue)
                        ? SqlMapper.LookupDbType(targetMemberType, targetMemberType.Name, true, out handler) : dbType;
        ...
        #region Nested type: CachedOutputSetters
    ...
    partial class FeatureSupport {
        ...
        public static FeatureSupport Get(IDbConnection connection) {
            ...
            if (string.Equals(name, "npgsqlconnection", StringComparison.InvariantCultureIgnoreCase)) {
                return postgres;
            }
            return @default;
        }
        ...
        public ConstructorInfo FindConstructor(string[] names, Type[] types) {
            ...
            foreach (
                ConstructorInfo ctor in
                    constructors.OrderBy(c => c.IsPublic ? 0 : (c.IsPrivate ? 2 : 1)).ThenBy(
                                                                                             c =>
                                                                                                 c.GetParameters()
                                                                                                  .Length)) {
        ...
        public SqlMapper.IMemberMap GetMember(string columnName) {
            ...
            if (property == null && MatchNamesWithUnderscores) {
                property =
                    _properties.FirstOrDefault(
                                               p =>
                                                   string.Equals(p.Name, columnName.Replace("_", ""),
            ...
            FieldInfo field = _fields.FirstOrDefault(p => string.Equals(p.Name, columnName, StringComparison.Ordinal))
                              ?? _fields.FirstOrDefault(
                                                        p =>
                                                            string.Equals(p.Name, columnName,
                                                                StringComparison.OrdinalIgnoreCase));
    ...
    internal class WrappedReader : IDataReader, IWrappedDataReader {
        ...
        bool IDataReader.IsClosed {
            get {
                return reader == null ? true : reader.IsClosed;
            }
        }
        ...
        #region IWrappedDataReader Members

        public IDataReader Reader {
            get {
                IDataReader tmp = reader;
                if (tmp == null) {
